...
**Chronos Mangler Edition** is a text editor that is designed to be simple yet efficient, being packed with only the essential features so you won't be stressed out, including 4 Soft and Nice Themes
```Blue, Red, Light and Dark!```
...
**NOTE: Currently in development, nothing is final. Many features are either unfinished or not implemented.**
